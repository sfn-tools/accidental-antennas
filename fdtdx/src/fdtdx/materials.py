...
class Material(TreeClass):
    ...
    #: Marks the material as a perfect electric conductor (PEC).
    #: When True, the solver enforces E=0 in cells assigned to this material.
    is_pec: bool = frozen_field(default=False)
    ...
    def __init__(
        ...
        *,
        ...
        object.__setattr__(self, "is_pec", bool(is_pec))
